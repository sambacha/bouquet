...
export const Configure = ({ provider, bundle, fundingAmountMin, signers, blockInfo, }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("h2", { className: 'font-bold text-2xl', children: "2. Configure" }), bundle.value ? (_jsxs(_Fragment, { children: [_jsxs("div", { className: 'flex flex-col w-full gap-4', children: [_jsx("h3", { className: 'text-2xl font-semibold', children: "Enter Private Keys For Signing Accounts" }), bundle.value.uniqueSigners.map((address) => (_jsxs(_Fragment, { children: [_jsx("span", { className: 'font-semibold -mb-2', children: address }), _jsx("input", { type: 'text', value: signerKeys.value[address].input, onInput: (e) => tryUpdateSigners(address, e.currentTarget.value), className: `p-4 text-lg rounded-xl border-slate-200/70 border-2 ${signerKeys.value[address].wallet ? 'bg-success/10' : signerKeys.peek()[address].input ? 'bg-error/10' : 'bg-background'}`, placeholder: `Private key for ${address}` })] })))] }), bundle.value?.containsFundingTx && signers.value.burner ? (_jsxs("div", { className: 'flex flex-col w-full gap-4', children: [_jsx("h3", { className: 'text-2xl font-semibold', children: "Deposit To Funding Account" }), _jsx("p", { children: "This is a temporary account, send only enough needed plus a tiny bit to account for rising gas price changes." }), _jsxs("span", { className: 'p-4 flex items-center gap-4 w-max rounded-xl text-lg bg-white text-background font-bold font-mono', children: [signers.value.burner.address, _jsx("button", { onClick: copyBurnerToClipboard, className: 'active:text-background/70', children: _jsx("svg", { className: 'h-8 inline-block', "aria-hidden": 'true', fill: 'none', stroke: 'currentColor', "stroke-width": '1.5', viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg', children: _jsx("path", { d: 'M16.5 8.25V6a2.25 2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 6v8.25A2.25 2.25 0 006 16.5h2.25m8.25-8.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-7.5A2.25 2.25 0 018.25 18v-1.5m8.25-8.25h-6a2.25 2.25 0 00-2.25 2.25v6', "stroke-linecap": 'round', "stroke-linejoin": 'round' }) }) })] }), _jsxs("p", { className: 'font-semibold', children: ["Wallet Balance: ", _jsx("span", { className: 'font-medium font-mono', children: utils.formatEther(signers.value.burnerBalance) }), " ETH", _jsx("br", {}), "Minimum Required Balance: ", _jsx("span", { className: 'font-medium font-mono', children: utils.formatEther(fundingAmountMin.value) }), " ETH"] })] })) : ('')] })) : (_jsx("p", { children: "No transactions imported yet." }))] }));
};
